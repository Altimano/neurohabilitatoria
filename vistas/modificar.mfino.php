    ...
    <div class="mx-6 md:mx-10 mb-6 bg-custom-main-box rounded-xl shadow-md p-6">
        <form id="evaluacionMotorFinoForm" action="?" method="post">
            ...
            <div class="border-t border-b border-gray-400 py-2 mb-6">
                <h1 class="text-xl font-semibold text-center text-gray-800">MOTOR FINO</h1>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4 mb-6">
                <div class="subescala">
                    <label for="mf_manos_linea_media" class="block text-sm font-medium text-gray-700 mb-1"><strong>Lleva las manos a la línea media</strong></label>
                ...
                <div class="subescala">
                    <label for="mf_mantiene_objeto" class="block text-sm font-medium text-gray-700 mb-1">Sostiene y mantiene firmemente un objeto con la mano</label>
                ...
                <div class="subescala">
                    <label for="mf_estruja_papel" class="block text-sm font-medium text-gray-700 mb-1"><strong>Estruja papel, sábanas, ropa, etc</strong></label>
                ...
                <div class="subescala">
                    <label for="mf_transfiere_manos" class="block text-sm font-medium text-gray-700 mb-1"><strong>Toma un objeto y lo transfiere entre sus manos</strong></label>
                ...
                <div class="subescala">
                    <label for="mf_examina_objetos" class="block text-sm font-medium text-gray-700 mb-1">Toma objetos que están a su alcance y los examina</label>
                ...
                <div class="subescala">
                    <label for="mf_desarrolla_agarre" class="block text-sm font-medium text-gray-700 mb-1"><strong>Comienza a desarrollar agarre índice-pulgar</strong></label>
                ...
                <div class="subescala">
                    <label for="mf_senala_indice" class="block text-sm font-medium text-gray-700 mb-1">Señala con el dedo índice</label>
                ...
                <div class="subescala">
                    <label for="mf_torre_2_cubos" class="block text-sm font-medium text-gray-700 mb-1"><strong>Forma una torre de dos cubos</strong></label>
                ...
                <div class="subescala">
                    <label for="mf_garabatea_imitacion" class="block text-sm font-medium text-gray-700 mb-1">Garabatea espontáneamente por imitación</label>
                ...
                <div class="subescala">
                    <label for="mf_toma_2_cubos_mano" class="block text-sm font-medium text-gray-700 mb-1">Toma dos cubos en una mano</label>
                ...
                <div class="subescala">
                    <label for="mf_torre_3_4_cubos" class="block text-sm font-medium text-gray-700 mb-1">Forma una torre con tres o cuatro cubos</label>
                ...
                <div class="subescala">
                    <label for="mf_vueltas_paginas" class="block text-sm font-medium text-gray-700 mb-1">Da vuelta a las páginas de un libro (dos o tres a la vez)</label>
                ...
                <div class="subescala">
                    <label for="mf_torre_6_cubos" class="block text-sm font-medium text-gray-700 mb-1"><strong>Arma torre de seis cubos</strong></label>
                ...
                <div class="subescala">
                    <label for="mf_arma_tren_3_cubos" class="block text-sm font-medium text-gray-700 mb-1">Arma tren de tres cubos</label>
