...
<body class="bg-gray-100">
    ...
    <div class="mx-6 md:mx-10 my-6 bg-custom-main-box rounded-xl shadow-md p-6">
        ...
        <form method="post" action="/consultar" class="flex flex-col sm:flex-row items-end space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
            ...
            <div class="w-full sm:flex-grow"> 
                <label for="nombre_buscar" class="block text-sm font-medium text-custom-title mb-1">Fecha de Evaluacion</label>
                <input 
                    type="text" 
                    id="fecha" 
                    name="fecha" 
            ...
            <div class="w-full sm:flex-grow"> 
                <label for="nombre_buscar" class="block text-sm font-medium text-custom-title mb-1">Codigo de paciente</label>
                <input 
                    type="text" 
                    id="codigo" 
                    name="codigo" 
